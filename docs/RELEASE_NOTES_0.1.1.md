...
- The DMG opens with a compact drag-to-Applications layout and integrated bilingual guidance, without a separate installation text file.
...
- DMG 설치 창을 간결한 앱 → Applications 배치와 한·영 안내로 정리하고, 별도 설치 안내 텍스트 파일을 제거했습니다.
