...
Status: `0.1.1` release candidate. The public tag and release are created only after the release workflow completes.
...
The `v0.1.1` release is prepared from a version-matched main tag by GitHub Actions. For development, build the app locally, then open the resulting app:
