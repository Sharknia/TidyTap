...
enum TidyTapStrings {
    ...
    static let accessibilityPermissionRequired = String(localized: "Accessibility is required. In System Settings > Privacy & Security > Accessibility, enable TidyTapHelper (it may appear as TidyTap). Return here; TidyTap will refresh to confirm access. Then turn your desired feature back on.", bundle: .main)
    static let inputMonitoringPermissionRequired = String(localized: "Input Monitoring is required. In System Settings > Privacy & Security > Input Monitoring, enable TidyTapHelper (it may appear as TidyTap). Return here; TidyTap will refresh to confirm access. Then turn your desired feature back on.", bundle: .main)
